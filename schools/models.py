...
class SchoolProfile(models.Model):
    ...
    def due_date(self):
        hard_coded_due_date = timezone.datetime(2018, 1, 9, tzinfo=self.created_at.tzinfo)
        if self.created_at < timezone.datetime(2018, 1, 7, tzinfo=self.created_at.tzinfo):
